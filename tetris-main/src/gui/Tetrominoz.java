...
public class Tetrominoz extends Tetromino{
	...
	public Tetrominoz(int x, int y, int dimensions) {
	    ...
	    grillesPositions[1][1][1] = 1;
	    grillesPositions[1][1][2] = 1;
	    grillesPositions[1][1][3] = -10;

	    grillesPositions[1][2][0] = -10;
	    grillesPositions[1][2][1] = -10;
	    grillesPositions[1][2][2] = 1;
	    grillesPositions[1][2][3] = 1;
	    ...
	    grillesPositions[3][1][1] = 1;
	    grillesPositions[3][1][2] = 1;
	    grillesPositions[3][1][3] = -10;

	    grillesPositions[3][2][0] = -10;
	    grillesPositions[3][2][1] = -10;
	    grillesPositions[3][2][2] = 1;
	    grillesPositions[3][2][3] = 1;
	...
	{
		Tetrominoz nouv = new Tetrominoz(this.x,this.y,this.largeur);
